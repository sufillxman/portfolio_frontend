...
const Hero = () => {
  ...
  return (
    <section id="home" ref={ref} className={`relative overflow-hidden px-2 pt-32 pb-16 md:px-0 transition duration-700 ${visible ? 'revealed' : ''}`}>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.45fr_1fr] items-start">
          ...
          <div className="space-y-8">
            <div className="max-w-3xl">
              <p className="mb-3 text-sm uppercase tracking-[0.3em] text-cyan-300/80">Portfolio</p>
              <h1 className="text-4xl font-semibold leading-tight text-white md:text-5xl handwritten">
                I&apos;m <span className="text-cyan-300 text-glow">Sufill X Man</span> — building fast AI-enabled web experiences.
              </h1>
              <p className="mt-5 max-w-2xl text-slate-300/90 leading-8">
                Modern fullstack portfolio with Django REST Framework backend, React frontend, and a polished coder-style interface that feels professional and confident.
              </p>
            </div>

            <div className="flex flex-col gap-4 sm:flex-row">
              <a href="#projects" className="btn-primary w-full text-center sm:w-auto">
                View Projects
              </a>
            </div>
          </div>
          ...
          <div className="glass-card group relative overflow-hidden rounded-[2rem] border border-cyan-500/10 bg-slate-900/75 p-6 shadow-glow">
            ...
            <div className="relative z-10 space-y-4">
              <p className="text-sm uppercase tracking-[0.26em] text-cyan-200/80">Live build status</p>
              <div className="rounded-3xl border border-slate-700/50 bg-slate-950/85 p-5 text-sm text-slate-300">
                <p className="font-mono text-cyan-300">const createPortfolio = async () =&gt; {'{'}</p>
                <p className="mt-2 font-mono text-slate-200">  await deploy();</p>
                <p className="font-mono text-slate-200">  return 'fullstack mastery';</p>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-3xl border border-slate-700/60 bg-slate-950/90 p-4 text-sm">
                  ...
                  <p className="mt-2 font-semibold text-white">React + Tailwind</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 rounded-3xl border border-cyan-400/20 bg-slate-900/80 p-6 text-slate-100 shadow-glow will-change-transform w-full mt-2">
            <p className="text-sm uppercase tracking-[0.25em] text-cyan-200/80 mb-4">I craft</p>
            <div className="flex flex-wrap items-baseline gap-3 min-h-[3rem] sm:min-h-[4rem] md:min-h-[5rem]">
